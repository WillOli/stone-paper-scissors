...
def iniciar_jogo():
    ...
    b_icon_1 = Button(frame_baixo, command=lambda: jogar('Stone'), width=50, image=icon_1, compound=CENTER, bg=co0,
    ...
    b_icon_2 = Button(frame_baixo, command=lambda: jogar('Paper'), width=50, image=icon_2, compound=CENTER, bg=co0,
                      fg=co0, font=('Ivy 10 bold'), anchor=CENTER, relief=FLAT)
    ...
    b_icon_3 = Button(frame_baixo, command=lambda: jogar('Scissor'), width=50, image=icon_3, compound=CENTER, bg=co0,
                      fg=co0, font=('Ivy 10 bold'), anchor=CENTER, relief=FLAT)
